...
2. Create a default server secret on the cluster - an example yaml for this can be found in the [NGINX Ingress Controller GitHub repo](https://github.com/nginxinc/kubernetes-ingress/blob/main/deployments/common/default-server-secret.yaml)
